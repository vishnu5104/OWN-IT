...
const CreateNFT = () => {
  ...
  return (
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-3/5 md:w-full">  <h1 className="font-poppins dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold ml-4 xs:ml-0">Post Your Land Details To Sell</h1>
        <div className="mt-16">
        ...
        <Input
          ...
          placeholder="Minimum 10 Maximum As Your Wish"
          handleClick={(e) => setFormInput({ ...formInput, price: e.target.value })}
        />

        <Input
          inputType="number"
          title="Price Per Ticket (ETH)"
